...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        {
            var user = await this.userManager.FindByEmailFromClaimPrincipal(User);
        ...
        {
            var user = await this.userManager.FindUserByClaimsPrincipalWithAddressAsync(User);
        ...
        public async Task<ActionResult<AddressDto>> UpdateUserAddress(AddressDto address)
        {
            ...
            return BadRequest("Problem occured when updating the user address!");
        }
